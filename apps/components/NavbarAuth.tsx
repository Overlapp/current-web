                    ...
                    <div className="w-full flex items-center justify-center md:justify-between">
                        <Link href="/">
                            <motion.div className="hover:cursor-pointer flex flex-col" initial={{ opacity: 0, translateY: -40 }} animate={{ opacity: 1, translateY: 0 }} transition={{ duration: 0.2 }}>
                                <h1 data-testid="navbarbrand" className="font-gilroy-bold text-2xl text-primary-pressed dark:text-neutral-10">
                                    NavbarAuth
                                </h1>
                                <p className="text-xs text-primary-pressed dark:text-neutral-10 font-gilroy-normal">Overlapp</p>
                            </motion.div>
                        </Link>
                        <Switcher />
                    </div>
